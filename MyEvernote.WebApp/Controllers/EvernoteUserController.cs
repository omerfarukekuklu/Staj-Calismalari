...
namespace MyEvernote.WebApp.Controllers
{
    ...
    public class EvernoteUserController : Controller
    {
        ...
        {
            return View(evernoteUserManager.ListQueryable().OrderByDescending(x => x.ModifiedOn));
        }
        ...
        public ActionResult Create(EvernoteUser evernoteUser)
        {
            ...
            {
                BusinessLayerResult<EvernoteUser> res = evernoteUserManager.InsertUser(evernoteUser);
        ...
        public ActionResult Edit(EvernoteUser evernoteUser)
        {
            ...
            if (ModelState.IsValid)
            {
                BusinessLayerResult<EvernoteUser> res = evernoteUserManager.UpdateUser(evernoteUser);
